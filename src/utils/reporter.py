...
def _print_demo_scaffold(scaffold: dict[str, Any]) -> None:
    """Prints the scaffold file tree for the demo report."""
...
def _print_demo_feature_maps(feature_maps: dict[str, Any]) -> None:
    """Prints the feature maps summary for the demo report."""
...
def _print_demo_next_steps() -> None:
    """Prints the next steps for the demo report."""
...
def print_demo_report(
    ...
    _print_demo_scaffold(scaffold)
    if feature_maps:
        _print_demo_feature_maps(feature_maps)
