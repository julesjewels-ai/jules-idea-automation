...
def _print_scaffold_preview(scaffold: dict[str, Any]) -> None:
    """Helper to print the generated scaffold file tree."""
...
def _print_feature_maps_summary(feature_maps: dict[str, Any]) -> None:
    """Helper to print a summary of MVP and Production feature maps."""
...
def _print_next_steps() -> None:
    """Helper to print the Next Steps guidance block."""
...
def print_demo_report(
    ...
    if feature_maps:
        _print_feature_maps_summary(feature_maps)
    _print_next_steps()
