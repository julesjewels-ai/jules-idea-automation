...
class IdeaWorkflow:
    ...
    def __init__(
        ...
        repository: Optional[ProjectRepository[WorkflowResult]] = None
    ):
        ...
        Args:
            ...
            repository: Repository to persist WorkflowResults (optional)
        """
    ...
    def execute(
        ...
        if self.repository:
            try:
                ...
                logger.error(f"Failed to save WorkflowResult to repository: {e}")
