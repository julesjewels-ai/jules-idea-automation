...
class IdeaWorkflow:
    ...
    def __init__(
        ...
        ----
            ...
            repository: ProjectRepository instance (optional)
    ...
    def execute(
        ...
        if self.repository:
            try:
                ...
                logger.error(f"Failed to save workflow result to repository: {e}")
    ...
    def _create_jules_session(
        self, username: str, idea_data: dict[str, Any], timeout: int, verbose: bool
    ) -> dict[str, Any] | None:
