...
class IdeaWorkflow:
    """Orchestrates the creation of a GitHub repo and Jules session from an idea.  # noqa: E501
    ...
    def _create_repository(self,
        ...
        if verbose:
            print(f"Creating {visibility} GitHub repository '{idea_data['slug']}'...")  # noqa: E501
    ...
    def _generate_scaffold(self,
        ...
        if verbose:
            print("Generating MVP scaffold with Gemini (this may take a moment)...")  # noqa: E501
        ...
        if files_to_create:
            ...
            if verbose:
                print(f"  Created {result['files_created']} files in single commit")  # noqa: E501
    ...
    def _create_jules_session(
        ...
        if verbose:
            ...
            print(f"Waiting for Jules to discover the new repository (timeout: {timeout}s)...")  # noqa: E501
        ...
        if not source_found:
            if verbose:
                print(f"WARNING: Source '{source_id}' was not found in Jules after {timeout}s.")  # noqa: E501
                print("Please visit https://jules.google.com to install the app.")  # noqa: E501
            return None
