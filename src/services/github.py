...
class GitHubClient:
    ...
    def _get_latest_commit_sha(
            self, owner: str, repo: str, branch: str) -> str:
    ...
    def _create_blobs(self, owner: str, repo: str,
                      files: list[dict[str, str]]) -> list[dict[str, Any]]:
        tree_items = []
    ...
    def _create_tree(self, owner: str, repo: str, base_tree_sha: str,
                     tree_items: list[dict[str, Any]]) -> str:
    ...
    def _create_commit(self, owner: str, repo: str, message: str,
                       tree_sha: str, parents: list[str]) -> str:
    ...
    def _update_ref(self, owner: str, repo: str, branch: str,
                    commit_sha: str) -> None:
        url = f"{self.base_url}/repos/{owner}/{repo}/git/refs/heads/{branch}"
