...
CATEGORY_PROMPTS = {
    ...
    "cli_tool": "Generate a useful command-line tool idea. Focus on developer "
                "productivity and Unix philosophy.",
    ...
    "default": "Generate a creative, unique, and useful software application "
               "idea."
}
...
class GeminiClient:
    ...
    def _generate_content(
        ...
        Args:
            ...
            schema: The Pydantic model or schema for response validation.
            error_tip: The tip to display on error.
    ...
    def generate_idea(self, category: Optional[str] = None) -> dict[str, Any]:
        ...
        Args:
            category: Optional category to target (web_app, cli_tool,
                      api_service, mobile_app, automation, ai_ml).

        Returns:
            The generated idea data.
        """
        base_prompt = CATEGORY_PROMPTS.get(
            category or "default", CATEGORY_PROMPTS["default"])
        prompt = (
            f"{base_prompt} Include recommended tech stack and "
            "key MVP features."
        )
    ...
    def generate_project_scaffold(
        ...
        Args:
            idea_data: Dict with title, description, slug, tech_stack,
                       features.
