"""Gemini AI API client for idea generation."""
...
class GeminiClient:
    ...
    def _process_api_response(self, text: str | None, schema: Any, cache_key: str, error_tip: str) -> dict[str, Any]:
        """Parse, cache, and validates the API response."""
        try:
    ...
    def _generate_content(self, prompt: str, schema: Any, error_tip: str) -> dict[str, Any]:
        """Generate content using fallback logic. with consistent configuration and error handling."""
