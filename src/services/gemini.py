...
class GeminiClient:
    ...
    def _generate_content(self, prompt: str, schema: Any, error_tip: str) -> dict:
        """Helper to generate content with consistent config and error handling."""
        ...
        for attempt in range(max_retries + 1):
            try:
                return self._generate_content(
                    ...
                    error_tip="Failed to generate scaffold." # Tip isn't used in catch-all exception block but required by helper
                )
