...
class GeminiClient:
    ...
    def _generate_content(self, prompt: str, schema: Type[BaseModel], error_tip: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # json.loads returns Any, but we expect a dict based on schema
    ...
    def generate_idea(self, category: Optional[str] = None) -> Dict[str, Any]:
        ...
        Returns:
            A dictionary containing the idea details.
        """
    ...
    def extract_idea_from_text(self, text: str) -> Dict[str, Any]:
        ...
        Returns:
            A dictionary containing the extracted idea details.
        """
    ...
    def generate_project_scaffold(self, idea_data: Dict[str, Any], max_retries: int = 2) -> Dict[str, Any]:
        ...
        Returns:
            ProjectScaffold as a dictionary.
        """
        # Sanitize inputs
        safe_title = escape(str(idea_data['title']))
        safe_desc = escape(str(idea_data['description'])[:500])
