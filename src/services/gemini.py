...
class GeminiClient:
    ...
    def _generate_content(self, prompt: str, schema: type, error_tip: str | None = None):
        """Helper to generate content from Gemini and parse JSON response."""
        ...
        try:
            ...
            raise GenerationError(
                ...
                tip=error_tip or "The AI model returned invalid JSON."
            )
