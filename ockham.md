...
Summary: Extracted logical blocks for scaffold preview, feature maps summary, and next steps into separate private helper functions (_print_scaffold_preview, _print_feature_maps_summary, and _print_next_steps) to flatten the logic tree and reduce complexity.
