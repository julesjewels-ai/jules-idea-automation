...
Summary: Extracted `_format_scaffold_tree` and `_format_feature_maps` helpers to flatten the logic tree without changing behavior, simplifying the monolithic `print_demo_report` function.
