...
**Summary:** Extracted `_get_field`, `_build_scaffold_preview`, and `_build_feature_maps_preview` to simplify dictionary/object access and preview UI construction, reducing nested conditionals.
