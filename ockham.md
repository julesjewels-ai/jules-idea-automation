...
Delta: Complexity Score 19 -> 6
Summary: Extracted deeply nested iteration and conditional logic into dedicated helper functions (`_extract_val`, `_build_scaffold_tree`, and `_build_feature_lines`) to simplify `print_demo_report` while preserving exact string equivalence.
