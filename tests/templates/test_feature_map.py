...
class TestProductionChecklistStaticFallback:
    ...
    def test_api_items_absent_for_non_api_stack(self) -> None:
        ...
        idea_no_api: dict[str, Any] = {"title": "CLI Tool", "slug": "cli-tool", "tech_stack": ["Python", "Click"]}
    ...
    def test_db_items_absent_for_non_db_stack(self) -> None:
        ...
        idea_no_db: dict[str, Any] = {"title": "CLI Tool", "slug": "cli-tool", "tech_stack": ["Python", "Click"]}
