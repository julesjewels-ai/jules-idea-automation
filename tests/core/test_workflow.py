...
def _make_workflow(
    *,
    ...
    # Note: memory states MagicMock return values shouldn't be compared using 'is' against '.default_return_value'.
    # We just set them unconditionally if they haven't been customized, or we check isinstance(..., MagicMock)
