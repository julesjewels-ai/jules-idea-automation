...
def _make_workflow(
    *,
    ...
    if (
        isinstance(gh.create_file.return_value, MagicMock)
        and gh.create_file.return_value is gh.create_file.default_return_value
    ):
        gh.create_file.return_value = {}
    if (
        isinstance(gh.create_files.return_value, MagicMock)
        and gh.create_files.return_value is gh.create_files.default_return_value
    ):
