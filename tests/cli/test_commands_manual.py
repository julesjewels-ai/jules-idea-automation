...
@patch('src.cli.commands._execute_and_watch')
@patch('src.utils.slugify.slugify')
def test_handle_manual_long_title(
    mock_slugify: MagicMock,
    mock_execute: MagicMock
) -> None:
    ...
    long_title = (
        ...
        "It goes on and on to exceed the limit. It definitely needs to be more "
        "than 100 characters to trigger the logic."
    )
