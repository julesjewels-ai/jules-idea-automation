...
def test_handle_manual_long_title(mock_slugify, mock_execute):
    ...
    long_title = (
        "This is a very long title that is actually a description of the "
        "project. It goes on and on to exceed the limit. It definitely "
        "needs to be more than 100 characters to trigger the logic.")
    ...
    expected_truncated = "This is a very long title that is actually a descr"
    assert idea_data["title"] == expected_truncated
