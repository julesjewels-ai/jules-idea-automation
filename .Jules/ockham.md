...
- **Summary:** Extracted `_handle_http_error` and `_extract_api_error_message` helpers to isolate error handling and parsing logic, significantly simplifying the main request method.
